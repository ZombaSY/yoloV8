...
# face_detection
model.train(data='pretrained/face_detection.yaml', epochs=1000, imgsz=96, batch=1024, hsv_h=0.5, hsv_s=0.5, hsv_v=0.5, patience=30, lr0=5e-6, optimizer='AdamW', cos_lr=True, warmup_epochs=10)  # train the model
