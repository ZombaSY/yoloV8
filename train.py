...
# Load a model
weights = 'pretrained/yolov8n.pt'   # runs/detect/train4/weights/best.pt, pretrained/yolov8m.pt
...
# face_detection
model.train(data='pretrained/face_detection.yaml', epochs=1000, imgsz=96, batch=1024, hsv_h=0.2, hsv_s=0.2, hsv_v=0.2, mosaic=0, patience=30, lr0=5e-6, optimizer='AdamW', cos_lr=True, warmup_epochs=10)  # train the model
