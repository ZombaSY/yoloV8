...
model = YOLO('pretrained/saved_model.pt')  # load a pretrained model (recommended for training)
...
success = model.export(format='tfjs', imgsz=96, simplify=True)  # export the model
